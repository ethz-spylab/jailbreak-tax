...
MODEL_SIZE="8B"  # This script uses 70B models
...
if [ "$MODEL_SIZE" == "8B" ]; then
    ...
    ATTACK_MODEL_FOR_FINETUNE_ALIGNMENT="ethz-spylab/Llama-3.1-8B-Instruct_do_bio_again"
    ATTACK_MODEL_FOR_SYSTEM_PROMPT_ALIGNMENT="ethz-spylab/Llama-3.1-8B-Instruct_do_bio"
elif [ "$MODEL_SIZE" == "70B" ]; then
    MODEL_PATH="meta-llama/Llama-3.1-70B-Instruct"
    ALIGNMENT_MODEL_PATH="ethz-spylab/Llama-3.1-70B-Instruct_refuse_biology"
    ATTACK_MODEL_FOR_FINETUNE_ALIGNMENT="ethz-spylab/Llama-3.1-70B-Instruct_do_biology_again_5e-5"
    ATTACK_MODEL_FOR_SYSTEM_PROMPT_ALIGNMENT="ethz-spylab/Llama-3.1-70B-Instruct_do_biology_5e-5"
else
