...
MANY_SHOT_FILE="Data/many-shot/data/many_shot_full_bio_250.txt"
MANY_SHOT_NUM_QUESTIONS=200

echo "Running stage: $selected_stage"
echo "Alignment type: $selected_type"
echo "Model size: $MODEL_SIZE"
echo "Many-shot file: $MANY_SHOT_FILE"
echo "Number of many-shot questions: $MANY_SHOT_NUM_QUESTIONS"
...
if [ $selected_type == "finetune" ]; then
    python run_jb_tax.py \
        ...
        --many_shot_file ${MANY_SHOT_FILE} \
        --many_shot_num_questions ${MANY_SHOT_NUM_QUESTIONS} \
        --api_or_local local \
